package com.group15.finalprojectenglishapp.admin.luyennoi;
...
import com.group15.finalprojectenglishapp.luyennghetoeic.CauLuyenNghe;
...
public class EditLuyenNoiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listDapAn.add("C");
        listDapAn.add("D");
        ArrayAdapter dapAnAdapter = new ArrayAdapter(EditLuyenNoiActivity.this,
...
//                startActivity(intent);
        ...
        imgEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (audio == ""){
                    Toast.makeText(EditLuyenNoiActivity.this, "Chưa điền đầy đủ thông tin", Toast.LENGTH_SHORT).show();
                }
                else {
                    switch (dapanDung) {
                        case "A":
...
//                        startActivity(intent);
    ...
    private CauLuyenNghe getLuyenNgheByID(int id) {
        database = Database.initDatabase(EditLuyenNoiActivity.this, DATABASE_NAME);
