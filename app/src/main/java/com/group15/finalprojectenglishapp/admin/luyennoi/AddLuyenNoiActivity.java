...
public class AddLuyenNoiActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listDapAn.add("C");
        listDapAn.add("D");
        ArrayAdapter dapAnAdapter = new ArrayAdapter(AddLuyenNoiActivity.this,
        ...
        imgAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (audio == "" || imgHinh.getDrawable() == null){
                    Toast.makeText(AddLuyenNoiActivity.this, "Chưa điền đầy đủ thông tin", Toast.LENGTH_SHORT).show();
                }
                else {
    ...
    private Boolean addLuyenNghe(int idbo, String dapanA, String dapanB, String dapanC, String dapanD, String dapanTrue, byte[] hinhAnh, String audio) {
        database = Database.initDatabase(AddLuyenNoiActivity.this, DATABASE_NAME);
