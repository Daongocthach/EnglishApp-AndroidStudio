package com.group15.finalprojectenglishapp.luyennghetoeic;
...
public class ListeningToeicActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(cauLuyenNghes.size() <= 0) {
            Toast.makeText(ListeningToeicActivity.this, "Nội dung sẽ cập nhật cập nhật trong thời gian sớm nhất! Mong mọi người thông càm!!", Toast.LENGTH_LONG).show();
            Intent error = new Intent(ListeningToeicActivity.this, LuyenNgheActivity.class);
            finish();
            startActivity(error);
        }
        else {
            ...
            this.ImgBT.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String mediaURL = URL;
                    MediaPlayerUtils.playURLMedia(ListeningToeicActivity.this, mediaPlayer, mediaURL);
                    //doStart();
                }
            });
            ...
            btnquit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    doStop();
                    Intent intent
                            = new Intent(ListeningToeicActivity.this,
    ...
    private void AddArrayCLN(){
        database = Database.initDatabase(ListeningToeicActivity.this, DATABASE_NAME);
...
//        if(pos==cursor.getCount()){
        if(pos==cauLuyenNghes.size()){
            ...
            Intent intent=new Intent(ListeningToeicActivity.this, FinishQuizLSActivity.class);
